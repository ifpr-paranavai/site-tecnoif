            ...
            <div class="collapse navbar-collapse" id="navbarsExample10">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item activate">
                        <a class="nav-link active" href="ensalamento.php">Ensalamento</a>
                    </li>
                    <li class="nav-item">
    ...
    <div class="container" style="margin-top: 20px;">
        <article>
            <div>
                ...
                <h2 class="display-5">Será disponibilizado após 08/11/2021</h2>
                    <!--<iframe height="1100" width="800" src="https://docs.google.com/document/d/e/2PACX-1vQMz18qWjQmti7ExaVSDvVwl5_tm1iAfakmvL5T0TFbS320xWCQtI-2Kw057qckDlANi6MmZNLRM85-/pub?embedded=true">
                    </iframe>-->
                </h2>
            </div>
        </article>
