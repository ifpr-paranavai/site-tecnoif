    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            <div id="content">
                ...
                <div class="container">
                    <form action="_atualizar_ano.php" method="post" style="margin-top: 20px">
                        <?php
		$sql = "SELECT * FROM `ano` WHERE idAno = $id";
		...
		?>
                        <div class="form-group">
                            ...
                            <input type="number" name="ano" class="form-control" value="<?php echo $ano ?>"
                                autocomplete="off">
                            <input type="hidden" class="form-control" name="id" value="<?php echo $idAno ?>" readOnly>
                        </div>
